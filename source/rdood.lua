...
if text == "فتح الردود بالصوره" then
    Redis:del(Zelzal.."Zelzal:Lock:ReplyPhoto"..msg.chat_id)
    send(msg.chat_id, msg.id, "✅ تم تفعيل الردود على الصور")
end
if text == "قفل الردود بالصوره" then
    Redis:set(Zelzal.."Zelzal:Lock:ReplyPhoto"..msg.chat_id, true)
    send(msg.chat_id, msg.id, "✅ تم تعطيل الردود  الصور")
end
if Redis:sismember(Zelzal.."Zelzal:Text:Cmd:Lock"..msg_chat_id,text) then
if Locks_Status(msg.sender_id.user_id,msg,text) ~= "noon" then
return send(msg_chat_id,msg_id,Locks_Status(msg.sender_id.user_id,msg,text),"md",true)
